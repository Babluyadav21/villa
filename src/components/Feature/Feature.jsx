...
const Feature = () => {
    return (
        <div className="home-featured px-4 py-12 sm:px-6 lg:px-8 xl:px-10 2xl:px-20 flex flex-col lg:flex-row items-center justify-between gap-10 bg-[#009CA1]">
            {/* Image Section */}
            ...
            <div className="w-full lg:w-1/2 px-4 sm:px-6 lg:px-8">
                <h2 className="text-red-600 font-bold text-start mb-4 text-lg sm:text-xl">| Featured</h2>
            ...
            <div className="w-full mt-12 lg:mt-0 lg:w-1/2 max-h-[480px] overflow-y-auto border border-gray-200 rounded-lg shadow-sm">
               <h2 className="sticky top-0 z-10 bg-white font-bold text-base sm:text-base text-center py-4 border-b border-b-[#FF9444] dark:text-amber-500">
